...
Insulin Secretion-Sensitivity Index-2 (ISSI-2). Partial least squares (PLS) used
with all FA as predictors and outcomes as response.
...
between the observed association with carbohydrates and diabetes risk.
