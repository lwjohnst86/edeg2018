...
### {data-height=80 .small}

**Aim**: To identify specific clusters in the composition of FA across multiple
lipid fractions by insulin sensitivity and beta-cell function.
...
Insulin Secretion-Sensitivity Index-2 (ISSI-2). Partial least squares (PLS) with
all FA as predictors and outcomes as response

**Results**: First two PLS components (C1 and C2) explained `r Y_explvar_issi2`-
`r Y_explvar_isi`% of variance in outcomes and `r X_explvar_issi2`-
`r X_explvar_isi`% in FA. TGFA and NEFA had strong negative loadings on C1 and
C2, respectively. Only some TGFA strongly correlated with PLS scores (i.e. `r tg_contrib`).
Lower PLS score (higher mol% of above TGFA) associated with `r estrange$estimate[1]`% 
lower ISI and `r estrange$estimate[2]`% lower ISSI-2.

**Conclusions**: A subset of TGFA strongly and negatively associated with
outcomes and that they are reported as markers of *de novo lipogenesis* from
carbohydrates. Suggests **only some FA** in serum may underlie association
between lipids and glucose dysregulation. These FA may also be **mediators**
between observed association with carbohydrates and diabetes risk.

<table style="width:100%">
<tr><td width="70%">
| **Contact**: 
| Luke W. Johnston, MSc, PhD (lwjohnst@ph.au.dk)
...
<img src="resources/au-logo.png" style="width:128px"></img> 
</td></tr>
</table>
